...
<meta name="verifyownership"
 content="02c92071ea213f01aa84f08ac2c3097e"/>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('media/css/homepage') }}" />
...
<?php kohana::log('info', '-> In homepage.blade.php...'); ?>
	...
	<div class="row" id="header">
			...
			<div class="col-xs-12 col-md-4 text-right">
				...
				<ul id="languages" class="list-inline">
					...
					<li>
				        <?= html::anchor('character/change_language/es_ES', html::image(array('src' => 'media/images/flags-lang/es.png'), array ('title' => 'Spanish', 'class' => 'img-responsive', 'alt' => 'Spanish flag')));?>
					</li>
				</ul>
			</div>
	</div>
