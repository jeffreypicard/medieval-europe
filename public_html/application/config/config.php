 ...
 * then a full URL will be used, eg: https://localhost/kohana/. If it only includes
 ...
 */
$config['internal_cache_key'] = 'purrpaomiaomiao';
 ...
 *
 * @see https://docs.kohanaphp.com/general/configuration
 */
